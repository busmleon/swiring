...
class ChangeInternshipPage extends StatelessWidget {
  // This widget is the root of your application.
  @override
  Widget build(BuildContext context) {
    return ChangeInternship();
  }
}

class ChangeInternship extends StatefulWidget {
  ChangeInternship({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _ChangeInternshipState createState() => _ChangeInternshipState();
}

class _ChangeInternshipState extends State<ChangeInternship> {
  ...
  String title = InternshipsService.selectedInternship.title;
  DateTime startDate = InternshipsService.selectedInternship.start;
  DateTime endDate = InternshipsService.selectedInternship.end;
  String selectedLocation = InternshipsService.selectedInternship.location;
  ...
  String documentId;
  String internshipPictureUrl = InternshipsService.selectedInternship.imageUrl;
  ...
  List<String> usedTags = InternshipsService.selectedInternship.tags;
  List<String> unusedTags = new List();

  List<DropdownMenuItem> unusedTagsItems = new List();

  void removeFromSkillTagList(int index) {
  ...
  void initState() {
    ...
    InternshipsService.selectedInternship.tags
        .forEach((elem) => InternshipsService.usedTags.add(elem));

    TagService.allSkillTags
        .forEach((elem) => InternshipsService.unusedTags.add(elem));
    InternshipsService.unusedTags
        .removeWhere((elem) => InternshipsService.usedTags.contains(elem));
                      ...
                      new Container(
                        ...
                        decoration: new BoxDecoration(
                          ...
                          image: new DecorationImage(
                            image: _image == null
                                ? NetworkImage(InternshipsService
                      ...
                      Row(
                        children: <Widget>[
                          ...
                          Expanded(
                            flex: 8,
                            child: TextFormField(
                              initialValue: InternshipsService
                                  .selectedInternship
                                  .getTitle(),
                        ...
                        children: <Widget>[
                          ...
                          Expanded(
                            ...
                            child: DateTimePicker(
                              selectDate: (value) => InternshipsService
                                  .selectedInternship.start = value,
                              labelText: 'from',
                      ...
                      Row(
                        children: <Widget>[
                          ...
                          Expanded(
                            ...
                            child: TextFormField(
                              initialValue: InternshipsService
                                  .selectedInternship.mentor.mail,
                      ...
                      Row(
                        children: <Widget>[
                          ...
                          Expanded(
                            ...
                            child: TextFormField(
                              initialValue: InternshipsService
                                  .selectedInternship.mentor.circuit,
                  ...
                  children: <Widget>[
                    ...
                    Container(
                        ...
                        child: FloatingActionButton.extended(
                          heroTag: "btnDelete",
                          onPressed: () => deleteInternship(),
                          label:
                              Text('Delete', style: TextStyle(color: atosBlue)),
  ...
  void deleteInternship() async {
    await showDialog(
        context: context,
        builder: (BuildContext context) => DeleteInternshipDialog());
  ...
  Future<void> uploadImage() async {
    final StorageReference firebaseStorageRef = FirebaseStorage.instance
        .ref()
        .child('internship_pictures/' +
            InternshipsService.selectedInternship.getDocId() +
            '.png');
    StorageUploadTask task = firebaseStorageRef.putFile(_image);
    internshipPictureUrl = await (await task.onComplete).ref.getDownloadURL();
  }

  Future updateInternship() async {
    try {
      if (_image != null) {
        await uploadImage();
      }
      await Firestore.instance
          ...
          .document(InternshipsService.selectedInternship.getDocId())
          .updateData({
        'circuit': circuit,
        'description': description,
        'end': endDate,
        'imageUrl': internshipPictureUrl,
      ...
      InternshipsService.selectedInternship = new Internship(
          docId: InternshipsService.selectedInternship.docId,
          title: title,
          location: selectedLocation,
          start: startDate,
          end: endDate,
          ...
          tags: InternshipsService.usedTags,
          imageUrl: internshipPictureUrl,
          mentor: new Mentor(name: name, mail: email, circuit: circuit));
      Navigator.pop(context);
    } catch (e) {
      print("*******" + e.toString());
    }
